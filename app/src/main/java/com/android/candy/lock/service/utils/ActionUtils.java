...
import com.android.candy.lock.action.MM_MessageClear;
import com.android.candy.lock.action.WeChar_PengyouquanLocation;
import com.android.candy.lock.action.WeChat_AutoAddFriends;
import com.android.candy.lock.action.WeChat_AutoHuifu;
import com.android.candy.lock.action.WeChat_AutoHuifu2;
import com.android.candy.lock.action.WeChat_DaShang;
import com.android.candy.lock.action.WeChat_DeleteFirends;
import com.android.candy.lock.action.WeChat_FirendsCheckDelete;
import com.android.candy.lock.action.WeChat_MessageClear;
import com.android.candy.lock.action.WeChat_Paishe;
import com.android.candy.lock.action.WeChat_QunFa2;
import com.android.candy.lock.action.WeChat_RedPackageAction;
import com.android.candy.lock.action.WeChat_Zan;
...
//        action06.event(event);
        ...
        if (MySettings.isAutoHF(con) && MySettings.isWeixin(con)) {
        ...
        if (MySettings.isWeixin(con)&&addFriends!=null)
