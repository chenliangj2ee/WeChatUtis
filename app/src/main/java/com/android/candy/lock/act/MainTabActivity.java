package com.android.candy.lock.act;
...
import com.android.candy.lock.floatview.FloatPrctureCutView;
import com.android.candy.lock.floatview.WeChat_FloatScreenRecorder;
import com.android.candy.lock.service.MyActionService;
import com.android.candy.lock.utils.DeviceUtils;
            ...
            if (checkAlertWindowsPermission() && checkStealFeature1()) {
                ...
                if (getVersion(this, getPackageName()).equals(getVersion(this, "com.tencent.mm"))) {
                    ...
                    if (MySettings.isWeixin(this)) {
                        ...
                        MobclickAgent.onEvent(this, "关闭微信插件");
                    }
                } else {
