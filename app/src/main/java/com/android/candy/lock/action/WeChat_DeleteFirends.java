...
import com.android.candy.lock.floatview.FriendDeleteingDialog;
    ...
    public void event(AccessibilityEvent event) {
        ...
        try {
            ...
            if (index == 0) {//点击通讯录
                ...
                List<AccessibilityNodeInfo> listviews = findId("com.tencent.mm:id/i2");//获取通讯录列表
                ...
                for (int i = itemIndex; i < listview.getChildCount(); i++, itemIndex++) {
                    ...
                    if (lastinfos != null && lastinfos.size() > 0) {
                        ...
                        List<AccessibilityNodeInfo> usernameTexts = findId(listview.getChild(i), "com.tencent.mm:id/ik");//获取用户名view
                ...
                AccessibilityNodeInfo info = findId("com.tencent.mm:id/ge").get(0).getChild(1).getChild(0);
                if (info != null) {
                    click(info);
                    index = 3;
                }
                ...
                List<AccessibilityNodeInfo> listviews = findId("com.tencent.mm:id/bwh");//好友菜单列表往下滑动
                ...
                List<AccessibilityNodeInfo> deletes = findId("com.tencent.mm:id/afm");//【删除】按钮
